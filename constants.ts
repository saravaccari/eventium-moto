...
export const tipiEvento: TipoEvento[] = ['Raduno', 'Festa', 'Epoca', 'Gita', 'Gara/Gimcana'];
...
export const province: string[] = [
    ...
    "Carbonia-Iglesias", "Caserta", "Catania", "Catanzaro", "Chieti", "Como", "Cosenza",
    ...
    "Pesaro e Urbino", "Pescara", "Piacenza", "Pisa", "Pistoia", "Pordenone", "Potenza",
